...
export function FloatingButtons() {
  return (
    <>
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/7978000361?text=Interested+in+Plot+at+Kailasha+Hill+Valley"
        target="_blank"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-card border-t border-border p-3 md:hidden">
        <div className="flex gap-3">
          <Button 
            variant="whatsapp" 
            className="flex-1"
            onClick={() => window.open("https://wa.me/7978000361?text=Interested+in+Plot+at+Kailasha+Hill+Valley", "_blank")}
          >
